...
def main():
  ...
  print("Positive tweets precentage: {} %".format(100*len(ptweets)/len(tweets)))
  # picking negative tweets from tweets
  ntweets = [tweet for tweet in tweets if tweet['sentiment'] == 'negative']
  # precentage of negative tweets
  print("Negative tweets precentage: {} %".format(100*len(ntweets)/len(tweets)))
  # precentage of neutral tweets
  print("Neutral tweets precentage: {} % ".format(100*len(tweets - ntweets - ptweets)/len(tweets)))
